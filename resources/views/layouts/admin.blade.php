        ...
        <div class="flex-col w-full md:flex md:flex-row md:min-h-screen">
                ...
                <div @click.away="open = false" class="flex flex-col flex-shrink-0 w-full text-gray-700 bg-white md:w-64 dark:text-gray-200 dark:bg-gray-800" x-data="{ open: false }">
                    <div class="flex flex-row items-center justify-between flex-shrink-0 px-8 py-4">
                        ...
                        <nav :class="{'block': open, 'hidden': !open}" class="flex-grow px-4 pb-4 md:block md:pb-0 md:overflow-y-auto bg-green-400">
                            <x-admin-nav-link :href="route('wellcome')" :active="request()->routeIs('wellcome')">
                                {{ __('Home') }}
                            </x-admin-nav-link>
                ...
                <main class="m-2 p-6 w-full">
                    <div>
                      ...
                      <div class="p-4 mb-4 text-sm text-green-800 rounded-lg bg-green-100 dark:bg-green-200 dark:text-green-800" role="alert">
                        <span class="font-medium">Success alert!</span> {{ session()->get('success'); }}
                      </div>
                      @endif
                      @if (session()->has('warning'))
                     <div class="p-4 mb-4 text-sm text-yellow-800 rounded-lg bg-yellow-100 dark:bg-yellow-800 dark:text-yellow-400" role="alert">
